...
TRAIN_PERIOD = 5.0
N_EPOCHS = 50
ROOT_PATH = "/workspace/birdsongs"
LATE_NORMALIZE = True
MAXIMIZE_METRIC = True
MAIN_METRIC = "valid_roc_auc"
PATH_TO_JSON_MAPPING = "data/bird2int_xcm.json"
PRECOMPUTE = False
REPLACE_PATHES = ("xcm", "xcm_hdf5")
DEBUG = False
N_CORES = 12
...
CONFIG = {
    "seed": 1243,
    "df_path": "data/train_classifier_xcm.csv",
    ...
    "train_function_args": {
        ...
        "wandb_logger_params": {"project": "classifiers", "id": None, "log_model": False},
        # Possible options
